...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaSail = exports.MangaSailInfo = void 0;
const MangaSailHelper_1 = require("./MangaSailHelper");
const paperback_extensions_common_1 = require("paperback-extensions-common");
const MangaSailParser_1 = require("./MangaSailParser");
const MangaSailInterceptor_1 = require("./MangaSailInterceptor");
const interceptors_1 = require("./interceptors");
exports.MangaSailInfo = {
    version: MangaSailHelper_1.VERSION,
    name: MangaSailHelper_1.NAME,
...
class MangaSail extends paperback_extensions_common_1.Source {
    constructor() {
        ...
        this.requestManager = createRequestManager({
            ...
            interceptor: new MangaSailInterceptor_1.MangaSailInterceptor([
                new interceptors_1.SearchImgInterceptor(() => this.requestManager),
                new interceptors_1.MangaDetailsInterceptor(this.cheerio, () => this.requestManager)
            ])
        });
    }
    getMangaShareUrl(mangaId) {
        return `${MangaSailHelper_1.BASE_DOMAIN}/content/${mangaId}`;
    }
    getCloudflareBypassRequest() {
        return createRequestObject({
            url: MangaSailHelper_1.BASE_DOMAIN,
    ...
    getSearchResults(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const search = (0, MangaSailParser_1.generateSearch)(query);
            const request = createRequestObject({
                url: `${MangaSailHelper_1.BASE_DOMAIN}/search/node/${search}`,
                method: MangaSailHelper_1.METHOD,
                headers: MangaSailHelper_1.HEADERS
            });
            const response = yield this.requestManager.schedule(request, 1);
            const $ = this.cheerio.load(response.data);
            const results = (0, MangaSailParser_1.parseSearch)($);
...
exports.AUTHOR = 'td0';
exports.HOMEPAGE = 'https://github.com/td0/';
// Manga Data
...
const mangaDetailFieldsMapper = (results) => {
    return results.reduce((result, field, idx) => {
        let fieldKey;
        switch (exports.MANGA_DETAILS_FIELDS[idx]) {
            case 'field_image2':
                fieldKey = 'image';
                break;
            case 'field_status':
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MangaSailInterceptor = void 0;
class MangaSailInterceptor {
...
exports.MangaSailInterceptor = MangaSailInterceptor;
...
exports.parseResponseObject = parseResponseObject;
...
const parseNodeId = ($) => {
    var _a, _b;
    return (_b = (_a = $('[rel=shortlink]').attr('href')) === null || _a === void 0 ? void 0 : _a.split('/').pop()) !== null && _b !== void 0 ? _b : '';
};
exports.parseNodeId = parseNodeId;
const parseChapterNumber = (name) => {
    const chapNum = name.match(/(\d+(\.\d+)?)(?!.*\d)/) || ['0'];
    return parseFloat(chapNum[0]);
};
...
const parseSearch = ($) => {
    ...
    return mangaList.map((item) => {
        var _a, _b;
        const id = (_b = (_a = $(item).attr('href')) === null || _a === void 0 ? void 0 : _a.split('/').pop()) !== null && _b !== void 0 ? _b : '';
        return createMangaTile({
            id,
            title: createIconText({ text: $(item).text() }),
            image: `https://${MangaSailHelper_1.INTERCEPT_SEARCH_IMG}/${id}`
        });
    });
};
exports.parseSearch = parseSearch;
const parseMangaData = (response) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
    const res = (0, exports.parseResponseObject)(response);
    return createManga({
        id: (_a = res === null || res === void 0 ? void 0 : res.id) !== null && _a !== void 0 ? _a : '',
        titles: (_b = res === null || res === void 0 ? void 0 : res.titles) !== null && _b !== void 0 ? _b : [''],
        image: (_c = res === null || res === void 0 ? void 0 : res.image) !== null && _c !== void 0 ? _c : '',
        status: (_d = res === null || res === void 0 ? void 0 : res.status) !== null && _d !== void 0 ? _d : paperback_extensions_common_1.MangaStatus.UNKNOWN,
        artist: (_e = res === null || res === void 0 ? void 0 : res.artist) !== null && _e !== void 0 ? _e : '',
        author: (_f = res === null || res === void 0 ? void 0 : res.author) !== null && _f !== void 0 ? _f : '',
        desc: (_g = res === null || res === void 0 ? void 0 : res.desc) !== null && _g !== void 0 ? _g : '',
        hentai: (_h = res === null || res === void 0 ? void 0 : res.hentai) !== null && _h !== void 0 ? _h : false,
        lastUpdate: new Date((_j = res === null || res === void 0 ? void 0 : res.lastUpdate) !== null && _j !== void 0 ? _j : '')
    });
};
exports.parseMangaData = parseMangaData;
const parseDetailField = ($, field) => {
    var _a, _b;
    let result;
    switch (field) {
        case 'field_image2':
        ...
        case 'field_artist':
            ...
            break;
        case 'body':
            result = (_b = (_a = $('div.field-item.even p').text()) === null || _a === void 0 ? void 0 : _a.split('summary:').pop()) !== null && _b !== void 0 ? _b : '';
            result = result.trim();
            break;
    }
    if (field === 'field_status') {
        if (result === 'Ongoing')
            result = paperback_extensions_common_1.MangaStatus.ONGOING;
        else if (result === 'Complete')
            result = paperback_extensions_common_1.MangaStatus.COMPLETED;
        else
            result = paperback_extensions_common_1.MangaStatus.UNKNOWN;
    }
    return result !== null && result !== void 0 ? result : '';
};
exports.parseDetailField = parseDetailField;
const parseChapterList = ($, mangaId) => {
    const chapterList = [];
    const $list = $('tbody tr').toArray();
    $list.forEach(($chapter) => {
        var _a, _b, _c, _d, _e, _f;
        const name = (_b = (_a = $('a', $chapter)) === null || _a === void 0 ? void 0 : _a.text()) !== null && _b !== void 0 ? _b : '';
        chapterList.push(createChapter({
            mangaId,
            name,
            id: (_e = (_d = (_c = $('a', $chapter)) === null || _c === void 0 ? void 0 : _c.attr('href')) === null || _d === void 0 ? void 0 : _d.split('/').pop()) !== null && _e !== void 0 ? _e : '',
            chapNum: (0, exports.parseChapterNumber)(name),
            langCode: paperback_extensions_common_1.LanguageCode.ENGLISH,
            time: new Date((_f = $('td + td', $chapter).text()) !== null && _f !== void 0 ? _f : ''),
        }));
    });
    return chapterList;
};
...
const parseChapterDetails = ($, mangaId, id) => {
    var _a, _b, _c, _d;
    const $script = $('script').toArray().filter(($s) => {
        var _a;
...
class MangaDetailsInterceptor {
    ...
    getDetailField(nodeId, field) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const $ = this.cheerio.load(data === null || data === void 0 ? void 0 : data.field[`${nodeId}:full:en`]);
    ...
    generateRawMangaData(response, results, isFromSearch) {
        var _a;
        const mangaData = (0, MangaSailHelper_1.mangaDetailFieldsMapper)(results);
        if (!isFromSearch) {
            const $ = this.cheerio.load(response.data);
            mangaData['id'] = (_a = response.request.url.split('/')) === null || _a === void 0 ? void 0 : _a.pop();
...
exports.MangaDetailsInterceptor = MangaDetailsInterceptor;

}).call(this)}).call(this,require("buffer").Buffer)
},{"../MangaSailHelper":51,"../MangaSailParser":53,"buffer":2}],55:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SearchImgInterceptor = void 0;
const MangaSailHelper_1 = require("../MangaSailHelper");
const MangaSailParser_1 = require("../MangaSailParser");
class SearchImgInterceptor {
...
exports.SearchImgInterceptor = SearchImgInterceptor;

},{"../MangaSailHelper":51,"../MangaSailParser":53}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SearchImgInterceptor = exports.MangaDetailsInterceptor = void 0;
var MangaDetailsInterceptor_1 = require("./MangaDetailsInterceptor");
Object.defineProperty(exports, "MangaDetailsInterceptor", { enumerable: true, get: function () { return MangaDetailsInterceptor_1.MangaDetailsInterceptor; } });
var SearchImgInterceptor_1 = require("./SearchImgInterceptor");
Object.defineProperty(exports, "SearchImgInterceptor", { enumerable: true, get: function () { return SearchImgInterceptor_1.SearchImgInterceptor; } });

},{"./MangaDetailsInterceptor":54,"./SearchImgInterceptor":55}]},{},[50])(50)
});
